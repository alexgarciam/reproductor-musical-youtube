...
<div id="contenedor" style="width: 1440px;height: 700px;">
	...
	<div id="superior" style="width: 1440px;height: 50px;color: white;border: 1px solid white;padding-left: 30px">
		...
		<table bordercolor="#FFF" border="0">
			<tr>
				...
				<td><a href="#" id="fullScreen">full screen</a> | <a href="javascript:ytplayer.setSize(640,480)">Tamaño a 640x480</a> | </td>
			</tr>
		</table>
		...
		<table width="100%" border="0" bordercolor="#F00">
			<tr>
				...
				<div id="lateralizq" style="padding-left: 0px;position: relative; ">
						...
						<div id="listasYEso" style="height: 150px">
							<ul>
								<li class="opcioneslistas"><a id="verCola" href="#">Cola de reproducción</a></li>
								<li class="opcioneslistas"><a id="artistasEscuchados" href="#">Artistas mas escuchados</a></li>
								<li class="opcioneslistas"><a id="temasEscuchados" href="#">Temas mas escuchados</a></li>
								<li class="opcioneslistas"><a id="artistasAlza" href="#">Artistas en alza</a></li>
								<li class="opcioneslistas"><a id="temasAlza" href="#">Temas en alza</a></li>
							</ul>
					...
					<div id="radio" align="center" style="text-align: center">
						<input type="radio" id="radio1" name="radio" value="video" /><label for="radio1">Modo Video</label>
						
						<input type="radio" id="radio2" name="radio" value="audio" /><label for="radio2">Modo Audio</label>			
					</div>
					<!--  Radio buttons -->
					 
					 	<!-- 	
					    <a id="ocultarVideo" id="ocultarVideo" href="#">Estas en el modo de Video. Cambiar a modo Música</a>						
					    <a id="verVideo" id="verVideo" href="#">Estas en el modo de musica. cambiar a modo Video Clip</a>
							 -->
	...
	<div id="footer">
		<table  align="center" >
			<tr>
				<td>
					<strong>Sputifly</strong> &copy; 2011
				</td>
				<td>
				|
				</td>
