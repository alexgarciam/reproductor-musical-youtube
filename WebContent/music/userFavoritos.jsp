...
<head>
	...
	$(function() {
		...
		$('#infoLista').html("<table><tr><td>"+htmlArtistas+"</td><td><table><tr><td><h2>Favoritos</h2></td></tr><tr><td>"+listaJSON.numeroCanciones+" canciones, "+duracionEnhorasMinutosYsegundos(listaJSON.duracion)+"</td></tr></table></td></tr></table>");
		...
		{		
			...
			var fila="<tr class='menufav' height='24px' id='cancion_"+lista[cont].idCancion+"_lista_"+lista[cont].lista+"'>"+
			"<td width='80px'></td><td >"+
		...
		*/
		...
		$('#tableListaUsuario tr').hover( function () {			
			...
			$(ee).html('<table><tr><td  align="left"><span style="margin-left:10px"><img src="images/botones/play_32.png" height="16px" onclick="reproducirFavorito(\''+id_padre+'\');"></span></td><td align="left"><span style="margin-left:10px"><img src="images/botones/plus_32.png" height="16px" onclick="ponerCancionDeFavoritosEnCola(\''+id_padre+'\');"></span></td></tr></table>');
			//alert('test');
		},function (){
			var id_padre=$(this).attr("id");
			//alert('id: '+id_padre);
